        ...
        this.qrScannerComponent.capturedQr.subscribe(function (result) {
            ...
            _this.authService.getOrden(idOrden).subscribe(function (data) {
                ...
                _this.authService.getVehiculo(data.orden.idVehiculo).subscribe(function (data) {
                    ...
                    console.log(_this.vehiculoTemp);
...
var AuthService = (function () {
    ...
    AuthService.prototype.eliminarCita = function (idCita) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/eliminarCita', { idCita: idCita }, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    AuthService.prototype.eliminarRepuesto = function (idRepuesto) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/eliminarRepuesto', { idRepuesto: idRepuesto }, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    ...
    AuthService.prototype.getOrdenesMecanico = function (idMecanico) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/getOrdenesMecanico', { idMecanico: idMecanico }, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    AuthService.prototype.getImagenesVehiculo = function (idVehiculo) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/obtenerImagenesVehiculo', { idVehiculo: idVehiculo }, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    ...
    AuthService.prototype.getImagenesOrden = function (idOrden) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/obtenerImagenesOrden', { idOrden: idOrden }, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    ...
    AuthService.prototype.getOrdenesFecha = function (fechas) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/getOrdenesFecha', { fechas: fechas }, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    AuthService.prototype.desactivarOrden = function (idOrden) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/desactivarOrden', { idOrden: idOrden }, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    AuthService.prototype.activarOrden = function (idOrden) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/users/activarOrden', { idOrden: idOrden }, { headers: headers })
            .map(function (res) { return res.json(); });
    };
